...
def test_IOS14():
  ...
  try:
    ...
    assertCheckPoint(driver, 'TID_001_1_IOS13', ERROR_MESSAGE)
    ...
    assertCheckPoint(driver, 'TID_001_2_IOS13', ERROR_MESSAGE)
    ...
    assertCheckPoint(driver, 'TID_001_3_IOS13', ERROR_MESSAGE)
    ...
    assertCheckPoint(driver, 'TID_001_4_IOS13', ERROR_MESSAGE)
    ...
    assertCheckPoint(driver, 'TID_001_5_IOS13', ERROR_MESSAGE)
