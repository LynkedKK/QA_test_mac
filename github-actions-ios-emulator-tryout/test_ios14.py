...
def test_IOS14():
  ...
  try:
    ...
    assertCheckPoint(json_metadata, driver, 'TID_001_1_IOS14', ERROR_MESSAGE)
    ...
    assertCheckPoint(json_metadata, driver, 'TID_001_2_IOS14', ERROR_MESSAGE)
    ...
    assertCheckPoint(json_metadata, driver, 'TID_001_3_IOS14', ERROR_MESSAGE)
    ...
    assertCheckPoint(json_metadata, driver, 'TID_001_4_IOS14', ERROR_MESSAGE)
    ...
    assertCheckPoint(json_metadata, driver, 'TID_001_5_IOS14', ERROR_MESSAGE)
