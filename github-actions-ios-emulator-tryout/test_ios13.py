...
def test_IOS13():
  ...
  try:
    ...
    assertCheckPoint(json_metadata, driver, 'TID_001_1_IOS13', ERROR_MESSAGE)
    ...
    assertCheckPoint(json_metadata, driver, 'TID_001_2_IOS13', ERROR_MESSAGE)
    ...
    assertCheckPoint(json_metadata, driver, 'TID_001_3_IOS13', ERROR_MESSAGE)
    ...
    assertCheckPoint(json_metadata, driver, 'TID_001_4_IOS13', ERROR_MESSAGE)
    ...
    assertCheckPoint(json_metadata, driver, 'TID_001_5_IOS13', ERROR_MESSAGE)
